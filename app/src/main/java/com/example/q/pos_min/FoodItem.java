...
public class FoodItem extends android.widget.CursorAdapter {

    com.example.q.pos_min.DatabaseManager DatabaseManager;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.dishName.setText(cursor.getString(cursor.getColumnIndex(DatabaseManager.MENU_DISHES)));
        holder.dishDescription.setText(cursor.getString(cursor.getColumnIndex(DatabaseManager.MENU_DESCRIPTION)));
        holder.dishPrice.setText(cursor.getString(cursor.getColumnIndex(DatabaseManager.MENU_PRICE)));
        holder.dishCuisinenType.setText(cursor.getString(cursor.getColumnIndex(DatabaseManager.MENU_CUISINETYPE)));
