...
public class CartScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MenuActivity.cartDishList.size()==0) {
            ...
            tvtTotal.setText("총 금액 = "+totalPrice+" 원");
            ...
            buttonCheckout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(CartScreen.this,
                            "주문이 완료되었습니다.", Toast.LENGTH_SHORT)
                            .show();

                    updateOrderTotalPrice(totalPrice);
                    Log.d("CartScreen.java","User Login Role ADMIN");
                    Intent intentCheckout = new Intent(CartScreen.this, OrderScreen.class);
    ...
    public void increment(View v)
    {
        ...
        Cursor c = DatabaseManager.getSingleMenu(currentDishName);


        int price = Integer.parseInt(c.getString(c.getColumnIndex(DatabaseManager.MENU_PRICE)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.cart_screen_logout: {
                Toast.makeText(CartScreen.this, "로그아웃 되었습니다.", Toast.LENGTH_SHORT)
                        .show();

                Intent intentLogout = new Intent(CartScreen.this, LoginActivity.class);
